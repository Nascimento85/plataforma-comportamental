...
function Card({ children, className = '' }: { children: React.ReactNode; className?: string }) {
  let devolutivaNode: React.ReactNode = null
  if (assessment.testType === 'DISC') devolutivaNode = isPrint ? <DiscPrintReport result={resultData as Record<string, unknown>} /> : <DiscDevolutiva d={resultData} />
  if (assessment.testType === 'MBTI') devolutivaNode = isPrint ? <MbtiPrintReport result={resultData as Record<string, unknown>} /> : <MbtiDevolutiva d={resultData} />
  if (assessment.testType === 'ENNEAGRAM') devolutivaNode = isPrint ? <EnneagramPrintReport result={resultData as Record<string, unknown>} /> : <EnneagramDevolutiva d={resultData} />
  if (assessment.testType === 'TEMPERAMENT') devolutivaNode = isPrint ? <TemperamentPrintReport result={resultData as Record<string, unknown>} /> : <TemperamentDevolutiva d={resultData} />
  if (assessment.testType === 'ARCHETYPE') devolutivaNode = isPrint ? <ArchetypePrintReport result={resultData as Record<string, unknown>} /> : <ArchetypeDevolutiva d={resultData} />
  if (assessment.testType === 'ARCHETYPE_FEMININE') devolutivaNode = isPrint ? <ArchetypeFemininePrintReport result={resultData as Record<string, unknown>} /> : <ArchetypeFeminineDevolutiva d={resultData} />
  if (assessment.testType === 'LOVE_LANGUAGES') devolutivaNode = isPrint ? <LoveLanguagesPrintReport result={resultData as Record<string, unknown>} /> : <LoveLanguagesDevolutiva d={resultData} />
  if (assessment.testType === 'CAREER_ANCHOR') devolutivaNode = isPrint ? <CareerAnchorPrintReport result={resultData as Record<string, unknown>} /> : <CareerAnchorDevolutiva d={resultData} />
  if (assessment.testType === 'EMOTIONAL_INTELLIGENCE') devolutivaNode = isPrint ? <EmotionalIntelligencePrintReport result={resultData as Record<string, unknown>} /> : <EmotionalIntelligenceDevolutiva d={resultData} />

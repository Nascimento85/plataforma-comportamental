...
export default function BackButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 inline-flex items-center gap-2 rounded-full px-4 py-3 text-[14px] font-bold text-white transition-all hover:-translate-y-0.5 print:hidden"

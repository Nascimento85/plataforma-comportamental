...
export default function PaywallPremium({ titulo, descricao }: Props) {
  return (
    <div className="max-w-2xl mx-auto py-10">
      ...
      <p className="text-[15.5px] text-soul-ink/90 font-medium leading-relaxed mb-6">
        {descricao}
      </p>

      <div className="rounded-2xl p-5 mb-6"
           style={{ background: 'rgba(212,184,92,0.08)', border: '1px solid rgba(201,168,76,0.30)' }}>
        <p className="text-[12px] font-bold uppercase tracking-widest mb-2" style={{ color: '#a87f1c' }}>
          O que vem incluso
        </p>
        <ul className="space-y-1.5 text-[15px] text-soul-ink/90 font-medium">
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-[15px] font-bold text-white shadow-terra no-underline transition-transform hover:-translate-y-px"
        style={{ background: 'linear-gradient(135deg, #c4633a, #d4943a)' }}
      >
        ✦ Começar trial de 7 dias
      </Link>
      <p className="text-[13.5px] text-soul-ink/75 font-medium mt-2">

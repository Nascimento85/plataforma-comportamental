    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Gerencie as avaliações dos seus colaboradores</p>
        </div>
        <NewAssessmentButton />
      </div>
      ...
      <div className="card overflow-hidden">
        {assessments.length === 0 ? (
          <div className="py-16 text-center text-gray-400">
            ...
            <p className="text-sm mt-1">Crie sua primeira avaliação para começar</p>
          </div>
        ) : (
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Criado em</th>

...
function StatusBadge({ status }: { status: string | null }) {
  ...
  return (
    <span
      className="inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[14px] font-semibold font-sans"
    ...
    <div className="space-y-6">
      ...
      {candidates.length === 0 ? (
        <div className="soul-panel text-center py-16">
          ...
          <p className="text-base text-soul-ink/85 font-medium mb-6 max-w-md mx-auto">
                ...
                {candidates.map((c) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      ...
                      <div className="text-[14px] text-soul-ink/80 font-medium mt-0.5">{c.email}</div>
                    </td>

    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="text-base text-soul-ink/88 mt-2 font-medium max-w-2xl leading-relaxed">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-5 py-3 rounded-full text-[15px] font-sans font-bold text-white transition-all hover:-translate-y-px shadow-terra"
      ...
      <section className="rounded-3xl p-6 md:p-8"
        ...
        <ul className="space-y-2 text-[15px] text-soul-ink font-medium">
      ...
      <section>
        ...
        {coletas.length === 0 ? (
          <div className="soul-panel text-center py-16">
            ...
            <p className="text-[15px] text-soul-ink/88 mb-6 max-w-md mx-auto font-medium">
              {setores.length === 0
            ...
            <Link
              href="/dashboard/compliance/nr1/nova"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-full text-[15px] font-bold text-white"
              style={{ background: 'linear-gradient(135deg, #c4633a, #d4943a)' }}
            >
              ...
              return (
                <Link key={c.id} href={`/dashboard/compliance/nr1/${c.id}`} className="soul-panel block hover:shadow-soul-lg transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span className="inline-flex items-center rounded-full px-3 py-1 text-[13px] font-bold"
                          style={{
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-4">
                    <div>
                      <p className="text-[12px] font-bold uppercase tracking-widest text-soul-ink/72">Convidados</p>
                      <p className="font-serif text-xl font-semibold text-soul-ink mt-0.5">{c._count.convites}</p>
                    </div>
                    <div>
                      <p className="text-[12px] font-bold uppercase tracking-widest text-soul-ink/72">Responderam</p>
                      <p className="font-serif text-xl font-semibold text-soul-terracota mt-0.5">{respondentesEstimados}</p>
                    </div>
                    <div>
                      <p className="text-[12px] font-bold uppercase tracking-widest text-soul-ink/72">Validade</p>
                      <p className="text-[14px] font-semibold text-soul-ink/88 mt-1">

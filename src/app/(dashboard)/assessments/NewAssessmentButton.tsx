          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
            {success ? (
              <div className="text-center">
                ...
                <h3 className="font-bold text-lg text-gray-900 mb-2">Avaliação criada!</h3>
                <p className="text-sm text-gray-500 mb-4">
                  Envie o link abaixo para o colaborador responder o teste:
                </p>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-sm font-mono break-all text-gray-800 mb-4">
                  {success.link}
                </div>
                <button
                ...
                <form onSubmit={handleCreate} className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button type="submit" disabled={loading} className="btn-primary flex-1">
                      {loading ? 'Criando...' : 'Criar e obter link'}
                    </button>
                  </div>
                </form>
              </>

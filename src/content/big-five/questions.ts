...
export const BIG_FIVE_QUESTIONS: BigFiveQuestion[] = [
  ...
  { id: 6,  factor: 'EXT', inverted: false, texto: 'Considero-me uma pessoa enérgica, dinâmica e de ritmo acelerado no dia a dia.' },
  ...
  { id: 32, factor: 'AMB', inverted: false, texto: 'Esforço-me para entender o ponto de vista do outro mesmo quando discordo completamente.' },
